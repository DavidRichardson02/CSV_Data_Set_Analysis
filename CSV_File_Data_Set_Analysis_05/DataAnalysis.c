...
void run_data_set(const char* dataSetFilePathName, char **fileContents, int lineCount, const char *delimiter)
{
    ...
    const char *dataSetDirectory = combine_char_ptr(dataSetFileDirectory, "");
    ...
    for (int i = 0; i < parameterCount; i++)
    {
        ...
        const char *parsedDataFilePathName = combine_char_ptr(parsedDataDirectory, combine_char_ptr("/", dataSetFileName));
