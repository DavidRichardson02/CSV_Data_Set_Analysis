...
// ------------------ Global Constants -------------------
// \{
static const size_t MAX_NUM_FILE_LINES = 100000;
...
/// \{
void print_file(const char* filePathName); // Prints the contents of a file to the console
void print_file_contents(char** fileContents, int countFileLines); // Prints file contents from a char array to the console
/// \}
